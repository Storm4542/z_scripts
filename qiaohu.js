...
cron "15 9 * * *" script-path=https://raw.githubusercontent.com/FoKit/Scripts/main/scripts/jparking_sign.js, tag=巧虎签到

http-request ^https://tv.qiaohuapp.com/api/v2.0/applySkin/getSkin script-path=https://raw.githubusercontent.com/FoKit/Scripts/main/scripts/jparking_sign.js, requires-body=true, timeout=10, enabled=false, tag=巧虎获取cookie
...
function checkIn() {
    ...
    let opt = {
        url: `https://tv.qiaohuapp.com/api/v2.0/taskIntegral/sign`,
        headers: {
            ...
            'Accept': '*/*',
            'User-Agent': 'Darwin',
            'Authorization': $.getdata(qiaohu_cookie),
            'Content-Length': '32',

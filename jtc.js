...
[Script]
获取捷停车userId = type=http-request, pattern=^https:\/\/sytgate\.jslife\.com\.cn\/core-gateway\/order\/carno\/pay\/info, requires-body=1, max-size=0, script-path=https://raw.githubusercontent.com/Storm4542/z_scripts/master/jtc.js

捷停车签到 = type=cron, cronexp=15 9 * * *, timeout=60, script-path==https://raw.githubusercontent.com/Storm4542/z_scripts/master/jtc.js, script-update-interval=0
...
cron "15 9 * * *" script-path==https://raw.githubusercontent.com/Storm4542/z_scripts/master/jtc.js, tag=捷停车签到

http-request ^https:\/\/sytgate\.jslife\.com\.cn\/core-gateway\/order\/carno\/pay\/info script-path==https://raw.githubusercontent.com/Storm4542/z_scripts/master/jtc.js, requires-body=true, timeout=10, enabled=false, tag=获取捷停车userId
